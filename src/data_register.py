...
DATA_REGISTER = [
    ...
    {
        "name": "Queensland official emergency and preparedness sources",
        "provider": "Queensland Government / Queensland Fire Department / local councils",
        "url": "https://www.qld.gov.au/legal/copyright",
        "licence": "Queensland Government content is generally CC BY 4.0 unless otherwise noted; verify each source page.",
        "local_files": ["data_australia/official_sources.yml"],
        "used_for": "Official source register and report verification links.",
        "limitations": "The app links to official sources but does not issue or verify live warnings and evacuation orders.",
    },
    {
