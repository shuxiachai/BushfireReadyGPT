OFFICIAL_SOURCES = [
    {
        "name": "Queensland Fire Department / QFD",
        "url": "https://www.fire.qld.gov.au/",
        "purpose": "Check Queensland bushfire safety, preparedness advice, warnings and incident guidance.",
        "when": "Use when the report needs Queensland fire agency preparedness or warning context.",
    },
    {
        "name": "Get Ready Queensland - Current Bushfire Incidents",
        "url": "https://www.getready.qld.gov.au/alerts-and-warnings/current-bushfire-incidents",
        "purpose": "Check Queensland's current bushfire incident information entry point.",
        "when": "Use when users need to verify whether current bushfire incident information exists.",
    },
    {
        "name": "Queensland Government Current Warnings",
        "url": "https://www.disaster.qld.gov.au/current-warnings",
        "purpose": "Check Queensland Government current disaster warnings and emergency information.",
        "when": "Use when a report needs current state-level warning verification.",
    },
    {
        "name": "Cairns Regional Council Disaster Information",
        "url": "https://www.cairns.qld.gov.au/community-and-environment/natural-disasters/stay-informed",
        "purpose": "Check Cairns local disaster information, council updates and local service impacts.",
        "when": "Use when the selected geography is Cairns or local council context is needed.",
    },
    {
        "name": "Bureau of Meteorology Queensland Warnings",
        "url": "https://www.bom.gov.au/qld/warnings/",
        "purpose": "Check Queensland weather warnings, fire weather and severe weather information.",
        "when": "Use when the report needs weather, heat, smoke, fire weather or severe weather context.",
    },
    {
        "name": "Triple Zero (000)",
        "url": "https://www.triplezero.gov.au/",
        "purpose": "Australian emergency number for life-threatening emergencies.",
        "when": "Call 000 for life-threatening fire, medical or rescue emergencies.",
    },
]
