...
request up to two stateless replacement attempts. The same `governed-report-v6`
...
attribution. This keeps orchestration reproducible, reduces latency and makes
